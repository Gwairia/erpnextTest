(function () {
	...
	frappe.views.ListView = class ListView extends frappe.views.BaseList {
		...
		get_list_view_settings() {
			...
			return frappe.call("frappe.desk.listview.get_list_settings", {doctype: this.doctype}).then(function (doc) { return this$1.list_view_settings = doc.message || {}; });
		}
		...
		get_checked_items(only_docnames) {
			var docnames = Array.from(this.$checks || [])
				.map(function (check) { return cstr($(check).data().name); });
	...
	frappe.views.ListSidebar = class ListSidebar {
		...
		get_html_for_assigned(name, count) {
			...
			var html = $('<li class="assigned"><a class="badge-hover" role="assigned-item"><span class="assigned-user">' 
